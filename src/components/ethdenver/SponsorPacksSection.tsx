...
// Declare custom Stripe element for TypeScript
declare global {
  // biome-ignore lint/suspicious/noExplicitAny: Stripe custom element
  namespace JSX {
...
const STRIPE_PUBLISHABLE_KEY =
  'pk_live_51RxyyDBoDen9clTaxuerQUFioGNixomGnhErSdXFRvSgR79wJfjhDICgCJ8HyMxC2DR5wkSVd4KUmJBHAu3wq9gh00p7QzvoKy'
...
export default function SponsorPacksSection() {
  ...
  return (
    <>
                    ...
                    {stripeLoaded ? (
                      <div
                        className={`stripe-button-wrapper ${
                          tier.highlighted ? 'highlighted-tier' : ''
                        }`}
                      >
                        <stripe-buy-button
      ...
      <style jsx>{`
        :global(.stripe-button-wrapper) {
          width: 100%;
        }
        :global(.stripe-button-wrapper stripe-buy-button) {
          width: 100%;
        }
        :global(.stripe-button-wrapper.highlighted-tier stripe-buy-button::part(button)) {
