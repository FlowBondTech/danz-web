    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
                ...
                <div className="flex items-center gap-5">
                  <div className="relative">
                    {sponsor.logoUrl ? (
                      ...
                      <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-neon-purple to-neon-pink flex items-center justify-center text-white text-3xl font-bold border-2 border-neon-purple/30">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto">
          {[
            { key: 'suggested', label: 'Suggested Events', icon: FiTarget },
            { key: 'active', label: 'Active Sponsorships', icon: FiActivity },
            { key: 'browse', label: 'Browse Events', icon: FiSearch },
          ].map(tab => (
            <button
              key={tab.key}
          ...
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-bg-secondary rounded-2xl border border-neon-purple/10 p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-text-secondary text-sm">Events Sponsored</span>
              </div>
              <p className="text-2xl font-bold text-text-primary">
            ...
            <div className="bg-bg-secondary rounded-2xl border border-neon-purple/10 p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-text-secondary text-sm">Workers Supported</span>
              </div>
              <p className="text-2xl font-bold text-text-primary">
            ...
            <div className="bg-bg-secondary rounded-2xl border border-neon-purple/10 p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-text-secondary text-sm">Avg Event Rating</span>
              </div>
              <p className="text-2xl font-bold text-text-primary">
        ...
        {dashboard?.recentActivity && dashboard.recentActivity.length > 0 && (
          <div className="mt-8 bg-bg-secondary rounded-2xl border border-neon-purple/10 p-6">
            ...
            <div className="space-y-3">
              {dashboard.recentActivity.slice(0, 5).map(transaction => (
                <div
                  key={transaction.id}
                  className="flex items-center justify-between p-3 bg-bg-primary/50 rounded-xl"
                >
    ...
    <div className="bg-bg-primary/50 rounded-xl border border-white/5 hover:border-neon-purple/30 transition-all overflow-hidden group">
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="w-full py-2 bg-neon-purple/20 hover:bg-neon-purple/30 border border-neon-purple/30 rounded-lg text-neon-purple font-medium text-sm transition-colors"
        >
          View & Sponsor
        </button>
      </div>
...
function ActiveSponsorshipCard({ sponsorship }: { sponsorship: any }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 bg-bg-primary/50 rounded-xl border border-white/5">
      {/* Event Image */}
      <div className="w-full sm:w-20 h-20 rounded-lg overflow-hidden shrink-0">
        {event?.image_url ? (
